...
// Query barang hilang yang aktif
                    ...
                    <div class="col-md-4 col-sm-6 mb-4" data-aos="fade-up">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <span class="badge bg-danger">Dicari</span>
                            </div>
                            <div class="card-footer bg-transparent border-0">
                                <a href="detail_barang.php?id=<?php echo $row['barang_id']; ?>" class="btn btn-primary w-100">Lihat Detail & Lapor Temuan</a>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center" role="alert">
                        <h4 class="alert-heading">Belum ada barang hilang</h4>
                        <p>Belum ada laporan barang yang hilang saat ini.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
